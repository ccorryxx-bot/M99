            ...
            <div class="s2-page">
              ...
              <div class="s2-footer">
                <button @click="step=1" class="s2-back-btn">
                  ...
                  <button @click="submitDeposit" :disabled="submitting" class="s2-confirm-btn" :class="submitting&&'s2-confirm-btn--busy'">
...
const paymentMethods = [
  ...
  { key:'uabpay', label:'UAB Pay', popular:false, img:'https://ik.imagekit.io/0xfxtkccz/Uab/1781076796857.png?tr=f-auto', iconText:'U', iconBg:'rgba(139,92,246,0.25)', iconColor:'#c084fc' },
]
