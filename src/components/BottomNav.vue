...
/* ── promotions gif slot (not logged in, position 4) ── */
.gnav-promo-gif {
...
.brain-wrap {
  ...
  box-shadow: 0 0 0 2px #1e2220, 0 0 12px rgba(59,130,246,0.45), 0 0 24px rgba(30,58,138,0.25);
