<template>
  <div class="nova-page-bg min-h-screen text-gray-200 pb-20 relative overflow-hidden">
    ...
    <div class="px-4 pt-6 space-y-3 relative z-10">
      <!-- Live Chat 1 -->
      <div @click="openChat(chatUrl1)" class="flex items-center gap-3 bg-[#2e3375] hover:bg-[#2e3375]/80 border border-cyan-500/10 rounded-xl p-3 cursor-pointer active:scale-98 transition-all">
        <span class="text-2xl">🤖</span>
        <span class="text-sm font-semibold">Live Chat 1</span>
      </div>

      <!-- Live Chat 2 -->
      <div @click="openChat(chatUrl2)" class="flex items-center gap-3 bg-[#2e3375] hover:bg-[#2e3375]/80 border border-cyan-500/10 rounded-xl p-3 cursor-pointer active:scale-98 transition-all">
        <span class="text-2xl">🤖</span>
        <span class="text-sm font-semibold">Live Chat 2</span>
      </div>

      <!-- Telegram Channel -->
      <a :href="telegramLink" target="_blank" class="flex items-center gap-3 bg-[#2e3375] hover:bg-[#2e3375]/80 border border-cyan-500/10 rounded-xl p-3 transition-all">
      ...
      <!-- Viber Channel -->
      <a :href="viberLink" target="_blank" class="flex items-center gap-3 bg-[#2e3375] hover:bg-[#2e3375]/80 border border-cyan-500/10 rounded-xl p-3 transition-all">
