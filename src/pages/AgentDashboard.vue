    ...
    <div style="position:relative;z-index:1;">
      ...
      <div style="padding-bottom:80px;">
        ...
        <div v-if="activeTab===0">
          ...
          <!-- Banner (compact) -->
          <div style="width:100%;overflow:hidden;max-height:145px;position:relative;">
            <img :src="agentBannerUrl" style="width:100%;height:145px;object-fit:cover;display:block;" @error="e=>e.target.style.display='none'" />
          ...
          <div style="margin:8px 10px 0;backdrop-filter:blur(20px) saturate(200%);-webkit-backdrop-filter:blur(20px) saturate(200%);background:rgba(255,255,255,0.1);border:1px solid rgba(255,255,255,0.18);border-radius:14px;overflow:hidden;box-shadow:0 6px 24px rgba(0,0,0,0.22),inset 0 1px 0 rgba(255,255,255,0.18);">
            ...
            <div style="padding:10px 12px 8px;display:flex;align-items:flex-start;gap:10px;">
              <button @click="showLevelModal=true" style="flex-shrink:0;width:38px;height:42px;background:none;border:none;cursor:pointer;padding:0;filter:drop-shadow(0 3px 8px rgba(245,158,11,0.4));" v-html="miniShieldHtml(currentLevelData||AGENT_LEVELS[0])"></button>
