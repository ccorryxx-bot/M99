...
/* ── Social row ── */
.social-row {
  display: flex; gap: 8px; justify-content: center; padding: 10px 4px 4px;
}
.social-btn {
...
.social-btn:active .social-icon { transform: scale(0.88); }
.social-icon {
  width: 52px; height: 52px; border-radius: 50%;
  display: flex; align-items: center; justify-content: center;
  transition: transform 0.15s;
}
.social-icon--share { background: rgba(255,255,255,0.15); border: 1.5px solid rgba(255,255,255,0.2); }
.social-icon--fb    { background: #1877f2; }
.social-icon--tg    { background: #229ed9; }
.social-icon--wa    { background: #25d366; }
.social-label {
  font-size: 10px; color: rgba(255,255,255,0.6); font-weight: 600; white-space: nowrap;
}
