<template>
  <div class="acc-root">
    ...
    <div class="acc-body">
      ...
      <div style="display:flex;align-items:center;gap:10px;padding:8px 0 10px;">
        ...
        <div style="display:flex;flex-direction:column;align-items:center;gap:3px;">
          ...
          <button @click="fetchWallet" class="ref-btn" :class="{ refreshing }">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" class="ref-svg">
      ...
      <button @click="$router.push('/home')" class="mrow">
        <div class="micon" style="background:rgba(255,255,255,0.1);"><svg width="15" height="15" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><rect x="2" y="14" width="20" height="7" rx="2"/><path d="M12 2v10m0 0l-3.5-3.5M12 12l3.5-3.5"/></svg></div>
        <span class="mlbl">ငွေထုတ်ရန်</span>
        <svg class="marr" fill="none" stroke="rgba(255,255,255,0.28)" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
      </button>
      <div class="thin-div"></div>
      <button @click="$router.push('/home')" class="mrow">
        <div class="micon" style="background:rgba(255,255,255,0.1);"><svg width="15" height="15" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><rect x="2" y="14" width="20" height="7" rx="2"/><path d="M12 12V2m0 0L8.5 5.5M12 2l3.5 3.5"/></svg></div>
        <span class="mlbl">ငွေသွင်းရန်</span>
        <svg class="marr" fill="none" stroke="rgba(255,255,255,0.28)" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
      </button>
      <div class="thin-div"></div>
      ...
      <div class="vip-card">
        ...
        <div style="position:relative;z-index:1;display:flex;align-items:flex-start;gap:6px;">
          <div class="vip-lv"><span style="font-size:11px;font-weight:900;color:#fff;">VIP{{ vipLevel }}</span></div>
          <div style="flex:1;min-width:0;padding-left:3px;">
            <div style="display:flex;flex-wrap:wrap;align-items:baseline;gap:2px;">
              <span style="font-size:10.5px;color:rgba(255,255,255,0.9);">လက်ကျန် </span>
              <span style="font-size:11px;font-weight:900;color:#fef9c3;font-style:italic;">VIP{{ nextLevel }}</span>
              <span style="font-size:10.5px;color:rgba(255,255,255,0.9);"> အားပြန်သင့်ရန် </span>
              <span style="font-size:11px;font-weight:900;color:#fff;">{{ formatCurrency(nextLevelTarget) }}</span>
            </div>
            <div style="font-size:10px;color:rgba(255,255,255,0.7);margin-top:1px;">လောင်းကြေးအတွက် {{ formatCurrency(nextLevelMaxDeposit) }}</div>
          </div>
          <svg width="12" height="12" fill="none" stroke="rgba(255,255,255,0.65)" stroke-width="2" viewBox="0 0 24 24" style="flex-shrink:0;margin-top:2px;"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
        </div>
        <div style="position:relative;z-index:1;height:1px;background:rgba(255,255,255,0.18);margin:7px 0;"></div>
        <div style="position:relative;z-index:1;">
          <div style="display:flex;align-items:center;gap:7px;margin-bottom:5px;">
            <div class="vip-coin"><span style="font-size:10px;font-weight:900;color:#fbbf24;">{{ vipLevel }}</span></div>
            <div style="flex:1;min-width:0;">
              <div style="display:flex;justify-content:space-between;margin-bottom:2px;">
                <span style="font-size:9.5px;color:rgba(255,255,255,0.85);">ပရိမိုးရှင်းအတွက် အားပြန်သင့်ဗုဒ္ဓ</span>
                <span style="font-size:9.5px;font-weight:700;color:#fff;white-space:nowrap;">{{ formatCurrency(deposited) }}/{{ formatCurrency(nextLevelTarget) }}</span>
              </div>
              <div class="vbar"><div class="vbar-f" :style="{ width: progressPercent + '%' }"></div></div>
            </div>
          </div>
          <div style="display:flex;align-items:center;gap:7px;">
            ...
            <div style="flex:1;min-width:0;">
              <div style="display:flex;justify-content:space-between;margin-bottom:2px;">
                <span style="font-size:9.5px;color:rgba(255,255,255,0.85);">ပရိမိုးရှင်းအတွက် လောင်းကြေး</span>
                <span style="font-size:9.5px;font-weight:700;color:#fff;white-space:nowrap;">{{ formatCurrency(deposited) }}/{{ formatCurrency(nextLevelMaxDeposit) }}</span>
              </div>
              <div class="vbar"><div class="vbar-f2" :style="{ width: wagProgressPercent + '%' }"></div></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <!-- ── Menu ── -->
      <div class="thin-div"></div>
      <button @click="comingSoon" class="mrow"><div class="micon" style="background:rgba(251,146,60,0.16);"><svg width="14" height="14" fill="none" stroke="#fb923c" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg></div><div style="flex:1;text-align:left;"><div class="mlbl">ငါ့မတ်တမ်း</div><div style="font-size:9px;color:rgba(255,255,255,0.3);margin-top:1px;">အသေးစိတ်၊ လောင်းကစား၊ အတိုရ</div></div><svg class="marr" fill="none" stroke="rgba(255,255,255,0.28)" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></button>
      <div class="thin-div"></div>
      <button @click="comingSoon" class="mrow"><div class="micon" style="background:rgba(239,68,68,0.13);"><svg width="14" height="14" fill="none" stroke="#f87171" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/></svg></div><span class="mlbl" style="flex:1;text-align:left;">ငွေထုတ်စီမံခန့်ခွဲမှု</span><svg class="marr" fill="none" stroke="rgba(255,255,255,0.28)" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></button>
      <div class="thin-div"></div>
      <button @click="$router.push('/agent')" class="mrow"><div class="micon" style="background:rgba(245,158,11,0.15);"><svg width="14" height="14" fill="none" stroke="#f59e0b" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg></div><span class="mlbl" style="flex:1;text-align:left;">အေးဂျင့်</span><span style="font-size:9px;font-weight:700;color:#d97706;margin-right:3px;">တစ်လဝင်ငွေ တစ်သန်း</span><svg class="marr" style="color:#d97706;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></button>
      <div class="thin-div"></div>
      <button @click="openProfile" class="mrow"><div class="micon" style="background:rgba(99,102,241,0.13);"><svg width="14" height="14" fill="none" stroke="#818cf8" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg></div><span class="mlbl" style="flex:1;text-align:left;">ကိုယ်ရေးအချက်အလက်များ</span><svg class="marr" fill="none" stroke="rgba(255,255,255,0.28)" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></button>
      <div class="thin-div"></div>
      <button @click="comingSoon" class="mrow"><div class="micon" style="background:rgba(34,197,94,0.13);"><svg width="14" height="14" fill="none" stroke="#4ade80" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg></div><span class="mlbl" style="flex:1;text-align:left;">လုံခြုံရေးစင်တာ</span><svg class="marr" fill="none" stroke="rgba(255,255,255,0.28)" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></button>
      <div class="thin-div"></div>
      <button @click="comingSoon" class="mrow"><div class="micon" style="background:rgba(14,165,233,0.13);"><svg width="14" height="14" fill="none" stroke="#38bdf8" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"/></svg></div><span class="mlbl" style="flex:1;text-align:left;">ဘာသာစကား</span><span style="font-size:9px;color:rgba(255,255,255,0.32);margin-right:3px;">မြန်မာဘာသာ</span><svg class="marr" fill="none" stroke="rgba(255,255,255,0.28)" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></button>
      <div class="thin-div"></div>
      <button @click="$router.push('/device-sessions')" class="mrow"><div class="micon" style="background:rgba(100,116,139,0.14);"><svg width="14" height="14" fill="none" stroke="#94a3b8" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17H3a2 2 0 01-2-2V5a2 2 0 012-2h14a2 2 0 012 2v10a2 2 0 01-2 2h-2"/></svg></div><span class="mlbl" style="flex:1;text-align:left;">ကိုယ်ပိုင်စက်ပစ္စည်းများ</span><svg class="marr" fill="none" stroke="rgba(255,255,255,0.28)" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></button>
      <div class="thin-div"></div>
      <button @click="logout" class="mrow"><div class="micon" style="background:rgba(239,68,68,0.12);"><svg width="14" height="14" fill="none" stroke="#f87171" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"/></svg></div><span class="mlbl" style="flex:1;text-align:left;color:#f87171;">အကောင့်ထွက်ရန်</span><svg class="marr" style="color:#f87171;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></button>
    </div>
        ...
        <div class="fp-body">
          ...
          <div style="display:flex;align-items:center;gap:13px;padding:16px 0 20px;">
            <div style="position:relative;cursor:pointer;" @click="openAvatarPicker">
              ...
              <div style="position:absolute;inset:0;border-radius:12px;background:rgba(0,0,0,0.3);display:flex;align-items:center;justify-content:center;">
                <svg width="17" height="17" fill="none" stroke="rgba(255,255,255,0.85)" stroke-width="1.8" viewBox="0 0 24 24">
            ...
            <div>
              <div style="font-size:10px;color:rgba(255,255,255,0.4);margin-bottom:3px;">တည်ဆောက်သည်</div>
              <div style="display:flex;align-items:center;gap:5px;">
          ...
          <div>
            ...
            <button @click="dropOpen = !dropOpen" style="width:100%;display:flex;align-items:center;gap:10px;padding:12px 12px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);border-radius:10px;cursor:pointer;text-align:left;transition:border-color 0.15s;" :style="dropOpen ? 'border-color:rgba(255,255,255,0.18);border-radius:10px 10px 0 0;' : ''">
              ...
              <svg width="14" height="14" fill="none" stroke="rgba(255,255,255,0.45)" stroke-width="2" viewBox="0 0 24 24" style="flex-shrink:0;transition:transform 0.2s;" :style="dropOpen ? 'transform:rotate(180deg);' : ''">
...
.thin-div { height:1px;background:rgba(255,255,255,0.07); }
...
.micon { width:28px;height:28px;border-radius:8px;display:flex;align-items:center;justify-content:center;flex-shrink:0; }
